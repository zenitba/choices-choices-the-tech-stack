...
const _sGlzLKsoEy = (function(nitro) {
...
const _lazy_XIiNSS = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_XIiNSS, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XIiNSS, lazy: true, middleware: false, method: undefined }
];
